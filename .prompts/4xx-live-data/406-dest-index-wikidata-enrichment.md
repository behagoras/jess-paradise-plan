...
6. Filters must DELIVER: the chosen month, vibe, and weather must visibly shape what surfaces (not just re-rank invisibly); a destination matching the user's filter should be evident in the results.
</requirements>
